                        ...
                        <div className="collapse navbar-collapse justify-content-end">
                            ...
                            <ul className="nav navbar-nav navbar-right">
...

                                {
                                    ...
                                    <li className="nav-item me-3 goldBackground rounded">
                                        <a className={"btn brownText fw-bold"} id={"ordersButton"} href={"/orders/processing"} >Processing orders</a>
                                    </li>
                                }

                                {
                                    localStorage.getItem("userRole") !== null &&
                                    (localStorage.getItem("userRole").endsWith("ADMIN") ||
                                        localStorage.getItem("userRole").endsWith("DELIVERY"))
                                     &&
                                    <li className="nav-item me-3 goldBackground rounded">
                                ...
                                {props.username !== undefined &&
                                <li className="nav-item me-3 goldBackground rounded">
                                    <a className={"btn brownText fw-bold"} id={"shoppingCartButton"} href={"/shoppingCart"}>Shopping cart</a>
                                </li>
                                }
